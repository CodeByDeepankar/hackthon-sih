...
import {
  ...
  CardHeader,
  CardTitle,
} from "@teacher/components/ui/card";
    ...
    <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="text-slate-600 mt-1">
                  Ready to continue monitoring your STEM students&#39; learning
                  journey?
                </div>
              </div>
            </div>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <Button
            variant="outline"
            className="bg-white/90 border-white text-violet-700 hover:bg-white"
          >
            View All Students
          </Button>
        </div>
