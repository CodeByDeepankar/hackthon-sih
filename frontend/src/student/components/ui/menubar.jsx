...
function MenubarContent({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }) { return (
    <MenubarPortal>
...
function MenubarItem({ className, inset, variant = "default", ...props }) { return (
...
function MenubarCheckboxItem({ className, children, checked, ...props }) { return (
...
function MenubarRadioItem({ className, children, ...props }) { return (
...
function MenubarLabel({ className, inset, ...props }) { return (
...
function MenubarSubTrigger({ className, inset, children, ...props }) { return (
