...
function SelectTrigger({ className, size = "default", children, ...props }) { return (
...
function SelectContent({ className, children, position = "popper", ...props }) { return (
...
function SelectItem({ className, children, ...props }) { return (
